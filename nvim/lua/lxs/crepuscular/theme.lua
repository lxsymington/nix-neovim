...
local theme = lush(function(injected_functions)
	...
	local bright = colours.bright
	local dim = colours.dim
	local standard = colours.standard
	...
	return {
		...
		BlinkCmpKindClass({ bg = standard.blue, fg = standard.background, gui = BoldUnderdouble.gui }),
		...
		BlinkCmpKindFolder({ bg = standard.green, fg = standard.background, gui = BoldUnderline.gui }),
