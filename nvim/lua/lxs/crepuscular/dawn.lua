...
local theme = lush.merge({
	...
	lush(function()
		return {
			...
			SpellBad({
				bg = colours.orange.saturation(36).lightness(75),
				gui = 'nocombine,undercurl',
			}),
			SpellCap({
				bg = colours.lightPurple.saturation(36).lightness(75),
				gui = 'nocombine,undercurl',
			}),
			SpellLocal({
				bg = colours.lightCyan.saturation(36).lightness(75),
				gui = 'nocombine,undercurl',
			}),
			SpellRare({
				bg = colours.lightOrange.saturation(36).lightness(75),
				gui = 'nocombine,undercurl',
			}),
