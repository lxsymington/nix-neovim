...
local theme = lush(function(injected_functions)
	...
	return {
		...
		Normal({ fg = standard.white, bg = standard.black }), -- Normal text
		...
		MsgArea({ fg = dim.white }), -- Area for messages and cmdline
		...
		PmenuExtra({ fg = dim.white }), -- Popup menu: Normal item "extra text"
		...
		String({ fg = dim.white }), --   A string constant: "this is a string"
		...
		Special({ fg = bright.white, gui = Underdot.gui, sp = standard.purple }), -- (*) Any special symbol
		...
		Delimiter({ fg = standard.yellow.mix(dim.white, 25) }), --   Character that needs attention
		...
		CmpItemAbbr({ fg = standard.white, gui = NoCombine.gui }),
