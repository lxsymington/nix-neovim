...
function M.attach(ev)
	...
	keymap.set('n', '<space>gt', lsp.buf.type_definition, desc('[lsp] go to type definition'))
	...
	keymap.set('n', '<C-k>', lsp.buf.signature_help, desc('[lsp] signature help'))
	keymap.set('n', '<space>wa', lsp.buf.add_workspace_folder, desc('[lsp] add workspace folder'))
	keymap.set(
		'n',
		'<space>wr',
	...
	keymap.set('n', '<space>wq', lsp.buf.workspace_symbol, desc('[lsp] workspace symbol'))
	keymap.set('n', '<space>dd', lsp.buf.document_symbol, desc('[lsp] document symbol'))
	keymap.set('n', '<M-CR>', lsp.buf.code_action, desc('[lsp] code action'))
	keymap.set('n', '<M-l>', lsp.codelens.run, desc('[lsp] run code lens'))
	keymap.set('n', '<space>cr', lsp.codelens.refresh, desc('[lsp] refresh code lenses'))
	keymap.set('n', 'gr', lsp.buf.references, desc('[lsp] find references'))
